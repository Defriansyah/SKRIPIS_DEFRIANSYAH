...
export const BenchmarkApp = component$(() => {
    ...
    return (
        <div>
            ...
            <button onClick$={runBenchmark} disabled={state.isBenchmarking}>
                {state.isBenchmarking ? 'Sedang Menjalankan Benchmark...' : 'Mulai Benchmark'}
            </button>
            <div>
